...
A deadpan rehearsal coach for conversations that don't need rehearsing.
...
It's the register-to-stakes mismatch that makes it land — a tone borrowed from sports psychology and clinical observation, applied to whether you successfully told someone their latte was cold.
...
The coach is a second LLM (Claude Sonnet) that narrates Inter-1's output in a flat, deadpan register. Inter-1 supplies clinical facts; the persona delivers them. The system prompt enforces:
...
Built for the Interhuman internal hackathon, June 2026.
